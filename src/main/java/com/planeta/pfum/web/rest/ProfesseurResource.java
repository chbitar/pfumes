...
public class ProfesseurResource {
	...
	public ResponseEntity<Professeur> createProfesseur(@RequestBody Professeur professeur) throws URISyntaxException {
		...
		return ResponseEntity
				.created(new URI("/api/professeurs/" + result.getId())).headers(HeaderUtil
	 ...
	 *         the updated professeur, or with status {@code 400 (Bad Request)} if
	 *         the professeur is not valid, or with status
	 *         {@code 500 (Internal Server Error)} if the professeur couldn't be
	 *         updated.
	 * @throws URISyntaxException if the Location URI syntax is incorrect.
	 */
	 ...
	 * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
	 *         the professeur, or with status {@code 404 (Not Found)}.
	 */
